...
const ReviewPublishArtifact: React.FC<ReviewPublishArtifactProps> = ({
  ...
  // Advanced Options popover — lets a reviewer pick which runner site (KTH /
  // deNBI) handles the test, mirroring the Edit page's site switch.
          ...
          <div className="flex items-center gap-4">
              ...
              <>
                ...
                {artifactInfo?.manifest && artifactInfo.manifest.type === 'model' && (
                  <>
                    {/* Advanced Options popover — runner-site selection, same as Edit. */}
                    <div className="relative" ref={advancedRef}>
                      <button
                        type="button"
                        onClick={() => setShowAdvancedOptions(v => !v)}
                        className="inline-flex items-center gap-1.5 px-3 py-2 h-10 rounded-md text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition-transform active:scale-[0.97]"
                      >
