...
const STEPS: TutorialStep[] = [
  ...
  { text: 'Draw Mask (D) \u2014 Draw freehand to create a segmentation mask. Release the mouse to complete the polygon.', highlightSelector: '[data-tool="polygon"]' },
  ...
  { text: 'Expand Mask (A) \u2014 Draw a freehand area to add to an existing mask. The drawn area is merged with the nearest intersecting mask.', highlightSelector: '[data-tool="expander"]' },
