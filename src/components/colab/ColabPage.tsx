  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-blue-50/30">
      <div className="max-w-[1400px] mx-auto px-6 py-6">
        {/* Vibrant Header (dataset overview renders its own merged header row) */}
        {!sessionId && (
          <div className="mb-8">
        ...
        <div className="max-w-7xl mx-auto min-h-[600px]">
          {sessionId ? (
            server ? (
              ...
              // No saved token: the store will never auto-connect, so
              // showing a spinner here would spin forever. Prompt to log in
              // directly instead (colab-rework-plan.md §21 item 2).
