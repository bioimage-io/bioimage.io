...
const BioEngineGuide: React.FC = () => {
  ...
  const getCommand = () => {
    ...
    const imageToUse = customImage || 'ghcr.io/aicell-lab/bioengine-worker:0.6.10';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="ghcr.io/aicell-lab/bioengine-worker:0.6.10"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: bioengine-worker
        image: ghcr.io/aicell-lab/bioengine-worker:0.6.10
        args:
        - "python"
        - "-m"
        - "bioengine.worker"
