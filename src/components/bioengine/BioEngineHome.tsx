        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-1">
              <img src="/static/img/bioengine-icon.svg" alt="BioEngine Logo" className="w-9 h-9" />
              <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent tracking-tight">
                BioEngine
              </h1>
            </div>
          ...
          <div className="flex-1 flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl shadow-md hover:shadow-lg hover:from-blue-700 hover:to-purple-700 active:scale-[0.98] transition-all duration-200 text-sm font-semibold"
            >
