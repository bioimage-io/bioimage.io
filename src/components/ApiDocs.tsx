        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mb-2">
              To use the API, you need an authentication token. You can obtain this by logging into the web interface
              and checking your browser's local storage for the 'token' key.
            </p>
          </div>
